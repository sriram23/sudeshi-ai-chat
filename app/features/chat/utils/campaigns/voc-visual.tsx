  ...
  return (
    <div className={styles.visual} aria-hidden="true">
      ...
      >
        ...
        <circle cx="360" cy="135" r="82" stroke="#FF9933" strokeWidth="1" strokeOpacity="0.18" />
        ...
        {/* Tiny route markers */}
        <circle cx="145" cy="160" r="4" fill="#64748B" fillOpacity="0.25" />

        <circle cx="575" cy="160" r="4" fill="#64748B" fillOpacity="0.25" />
